...
def calcRuntTime(audio_startstop, filename, sample_rate, samples, audio_length, time_array):
    runtimes = []
...
calcRuntTime(audio_startstop, filename, sample_rate, samples, audio_length, time_array)